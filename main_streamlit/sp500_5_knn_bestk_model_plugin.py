...
def sp500_knn_bestk_model():
    ...
    sp500_actual_vs_strategy_returns_knn = (1 + sp500_predictions_df_knn[["actual_returns", "strategy_returns"]]).cumprod()
    
    # Create a line plot of the cumulative returns
    plot_sp500_actual_vs_strategy_returns_knn, ax = plt.subplots(figsize=(10, 6))
    ax.plot(sp500_actual_vs_strategy_returns_knn)
    ax.legend(sp500_actual_vs_strategy_returns_knn.columns)
    ax.set_xlabel('Date')
