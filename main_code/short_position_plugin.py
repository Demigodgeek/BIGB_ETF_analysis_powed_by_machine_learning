...
def short_position_data_preparation():
    ...
    return X_train_scaled, X_test_scaled, y_train, y_test, sp_signals_df
...
# Plot Entry and Exit Points of DMAC Short Position Trading Strategy
def short_position_entry_exit_plot(sp_signals_df):
